...
export 'listado_productos_model.dart';
...
class ListadoProductosWidget extends StatefulWidget {
  ...
  static String routePath = '/listadoProductos';

  @override
  State<ListadoProductosWidget> createState() => _ListadoProductosWidgetState();
}

class _ListadoProductosWidgetState extends State<ListadoProductosWidget> {
  late ListadoProductosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadoProductosModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProductsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductsRecord> listadoProductosProductsRecordList =
            snapshot.data!;
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      DetalleProductoWidget.routeName,
                                      queryParameters: {
