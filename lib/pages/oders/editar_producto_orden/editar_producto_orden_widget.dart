...
import 'editar_producto_orden_model.dart';
export 'editar_producto_orden_model.dart';

class EditarProductoOrdenWidget extends StatefulWidget {
  const EditarProductoOrdenWidget({
    super.key,
    required this.tableOrderDetailsDoc,
    required this.tableOrderDoc,
  });

  final TableOrderDetailsRecord? tableOrderDetailsDoc;
  final TableOrdersRecord? tableOrderDoc;

  static String routeName = 'editarProductoOrden';
  static String routePath = '/editarProductoOrden';

  @override
  State<EditarProductoOrdenWidget> createState() =>
      _EditarProductoOrdenWidgetState();
}

class _EditarProductoOrdenWidgetState extends State<EditarProductoOrdenWidget> {
  late EditarProductoOrdenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarProductoOrdenModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().totalBeforeAddingToCart =
          widget.tableOrderDetailsDoc!.total;
      FFAppState().subtotalBeforeAddingToCart =
          functions.calculateSubtotalBeforeEditFunction(
              widget.tableOrderDetailsDoc!.total,
              widget.tableOrderDetailsDoc!.amount);
      FFAppState().productCount = widget.tableOrderDetailsDoc!.amount;
      FFAppState().extraIngredients = widget
          .tableOrderDetailsDoc!.extraIngredients
          .toList()
    ...
    _model.addicionalDescriptionTextController ??= TextEditingController(
      ...
      widget.tableOrderDetailsDoc?.description,
      'Agrega un descripción(opcional)',
    ));
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductsRecord>(
      stream:
          ProductsRecord.getDocument(widget.tableOrderDetailsDoc!.productRef!),
      builder: (context, snapshot) {
        ...
        final editarProductoOrdenProductsRecord = snapshot.data!;
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          editarProductoOrdenProductsRecord.photoUrl,
                    ...
                    Padding(
                      ...
                      child: Text(
                        editarProductoOrdenProductsRecord.name,
                        style: FlutterFlowTheme.of(context)
                            .headlineMedium
                            .override(
                              fontFamily: 'Outfit',
                    ...
                    Padding(
                      ...
                      child: Text(
                        formatNumber(
                          editarProductoOrdenProductsRecord.price,
                    ...
                    Padding(
                      ...
                      child: Text(
                        editarProductoOrdenProductsRecord.description,
                      ...
                      child: StreamBuilder<List<ExtraIngredientsRecord>>(
                        stream: queryExtraIngredientsRecord(
                          queryBuilder: (extraIngredientsRecord) =>
                            ...
                            'productRef',
                            isEqualTo:
                                editarProductoOrdenProductsRecord.reference,
                          ),
                          singleRecord: true,
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<ExtraIngredientsRecord>
                              columnExtraIngredientsRecordList = snapshot.data!;
                                  ...
                                  child: StreamBuilder<
                                    ...
                                    stream: queryExtraIngredientsRecord(
                                      queryBuilder: (extraIngredientsRecord) =>
                                        ...
                                        'productRef',
                                        isEqualTo:
                                            editarProductoOrdenProductsRecord
                                                .reference,
                                      ),
                                    ),
                                    builder: (context, snapshot) {
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.addicionalDescriptionFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.tableOrderDetailsDoc!.reference.update({
                            ...createTableOrderDetailsRecordData(
                              description: _model
                                  .addicionalDescriptionTextController.text,
                              total: FFAppState().totalBeforeAddingToCart,
                              amount: FFAppState().productCount,
                            ),
                            ...mapToFirestore(
                              {
                                'extra_ingredients':
