...
import 'agregar_orden_model.dart';
export 'agregar_orden_model.dart';

class AgregarOrdenWidget extends StatefulWidget {
  const AgregarOrdenWidget({
    super.key,
  ...
  static String routeName = 'agregarOrden';
  static String routePath = '/agregarOrden';

  @override
  State<AgregarOrdenWidget> createState() => _AgregarOrdenWidgetState();
}

class _AgregarOrdenWidgetState extends State<AgregarOrdenWidget> {
  late AgregarOrdenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarOrdenModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().totalBeforeAddingToCart = widget.productRef!.price;
      FFAppState().subtotalBeforeAddingToCart = widget.productRef!.price;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final agregarOrdenProductsRecord = snapshot.data!;
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                agregarOrdenProductsRecord.photoUrl,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 4.0, 0.0, 0.0),
                            child: Text(
                              agregarOrdenProductsRecord.name,
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                                  .override(
                                    fontFamily: 'Outfit',
                          ...
                          Padding(
                            ...
                            child: Text(
                              formatNumber(
                                agregarOrdenProductsRecord.price,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 4.0, 16.0, 0.0),
                            child: Text(
                              agregarOrdenProductsRecord.description,
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                                    fontFamily: 'Outfit',
                                                        ...
                                                        children: [
                                                          Theme(
                                                            ...
                                                            child: Checkbox(
                                                              value: _model
                                                                      .checkboxValueMap[
                                                                  listViewExtraIngredientsRecord] ??= false,
                                                              onChanged:
                                                                  (newValue) async {
                                                                safeSetState(() =>
                      ...
                      onPressed: () async {
                        await CarritoRecord.collection.doc().set({
                          ...createCarritoRecordData(
                            ...
                            subtotal: agregarOrdenProductsRecord.price,
                            extraDescription:
