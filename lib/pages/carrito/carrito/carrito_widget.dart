                            ...
                            Row(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://cdn-icons-png.flaticon.com/512/5901/5901581.png',
                                    width: 200.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title:
                                                            Text('Advertencia'),
                                                        content: Text(
                                                            'Desea eliminar todos los prodcutos del carrito?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              Text('Advertencia'),
                                                                          content:
                                                                              Text('Desea eliminar este prodcuto del carrito?'),
                                                                          actions: [
                                                                            TextButton(
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed(
                                          FinalizarCompraWidget.routeName);
                                    },
