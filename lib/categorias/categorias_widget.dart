          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  FFButtonWidget(
                    ...
                    options: FFButtonOptions(
                      ...
                      color: FlutterFlowTheme.of(context).smokers5,
                      textStyle:
              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    final prueba = getCurrentRouteStack(context)
                        .toList()
                        .take(20)
                        .toList();
                    ...
                    return FlutterFlowDataTable<String>(
                      ...
                      dataRowBuilder: (pruebaItem, pruebaIndex, selected,
                              onSelectChanged) =>
                          DataRow(
                      ...
                      dataRowHeight: 48.0,
                      columnSpacing: 20.0,
                      headingRowColor: FlutterFlowTheme.of(context).smokers4,
                      borderRadius: BorderRadius.circular(8.0),
