...
import 'editar_orden_model.dart';
export 'editar_orden_model.dart';

class EditarOrdenWidget extends StatefulWidget {
  const EditarOrdenWidget({
    super.key,
    required this.carritoDocument,
  });

  final CarritoRecord? carritoDocument;

  static String routeName = 'editarOrden';
  static String routePath = '/editarOrden';

  @override
  State<EditarOrdenWidget> createState() => _EditarOrdenWidgetState();
}

class _EditarOrdenWidgetState extends State<EditarOrdenWidget> {
  late EditarOrdenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarOrdenModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().totalBeforeAddingToCart = valueOrDefault<double>(
        widget.carritoDocument?.total,
        0.0,
      );
      FFAppState().subtotalBeforeAddingToCart =
          functions.calculateSubtotalBeforeEditFunction(
              widget.carritoDocument!.total,
              widget.carritoDocument!.cantidad);
      FFAppState().productCount = widget.carritoDocument!.cantidad;
      FFAppState().extraIngredients = widget.carritoDocument!.extraIngredients
          .toList()
          .cast<DocumentReference>();
      FFAppState().cartDocumentRef = widget.carritoDocument?.reference;
      safeSetState(() {});
    });

    _model.addicionalDescriptionTextController ??=
        TextEditingController(text: widget.carritoDocument?.extraDescription);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductsRecord>(
      stream: ProductsRecord.getDocument(widget.carritoDocument!.productRef!),
      builder: (context, snapshot) {
        ...
        final editarOrdenProductsRecord = snapshot.data!;
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                editarOrdenProductsRecord.photoUrl,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 4.0, 0.0, 0.0),
                            child: Text(
                              editarOrdenProductsRecord.name,
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                                  .override(
                                    fontFamily: 'Outfit',
                          ...
                          Padding(
                            ...
                            child: Text(
                              formatNumber(
                                editarOrdenProductsRecord.price,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 4.0, 16.0, 0.0),
                            child: Text(
                              editarOrdenProductsRecord.description,
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                                    fontFamily: 'Outfit',
                            ...
                            child: StreamBuilder<List<ExtraIngredientsRecord>>(
                              stream: queryExtraIngredientsRecord(
                                queryBuilder: (extraIngredientsRecord) =>
                                  ...
                                  'productRef',
                                  isEqualTo:
                                      editarOrdenProductsRecord.reference,
                                ),
                                singleRecord: true,
                              ),
                              builder: (context, snapshot) {
