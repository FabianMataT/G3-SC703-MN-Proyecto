...
import 'agregar_producto_orden_model.dart';
export 'agregar_producto_orden_model.dart';

class AgregarProductoOrdenWidget extends StatefulWidget {
  const AgregarProductoOrdenWidget({
    super.key,
  ...
  final ProductsRecord? productoDoc;

  static String routeName = 'agregarProductoOrden';
  static String routePath = '/agregarProductoOrden';

  @override
  State<AgregarProductoOrdenWidget> createState() =>
      _AgregarProductoOrdenWidgetState();
}

class _AgregarProductoOrdenWidgetState
    extends State<AgregarProductoOrdenWidget> {
  late AgregarProductoOrdenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarProductoOrdenModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().subtotalBeforeAddingToCart = widget.productoDoc!.price;
      FFAppState().totalBeforeAddingToCart = widget.productoDoc!.price;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    valueOrDefault<String>(
                      widget.productoDoc?.description,
                  ...
                  child: StreamBuilder<List<ExtraIngredientsRecord>>(
                    stream: queryExtraIngredientsRecord(
                      queryBuilder: (extraIngredientsRecord) =>
                        ...
                        'productRef',
                        isEqualTo: widget.productoDoc?.reference,
                      ),
                      singleRecord: true,
                    ),
                          ...
                          if (columnExtraIngredientsRecord != null)
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 10.0, 0.0, 0.0),
                              child:
                                  StreamBuilder<List<ExtraIngredientsRecord>>(
                                stream: queryExtraIngredientsRecord(
                                  queryBuilder: (extraIngredientsRecord) =>
                                      extraIngredientsRecord.where(
                                    'productRef',
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              valueOrDefault<String>(
                                FFAppState().totalBeforeAddingToCart.toString(),
                                '00,0',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await TableOrderDetailsRecord.collection.doc().set({
                        ...createTableOrderDetailsRecordData(
                          tableOrderRef: widget.tableOrderDoc?.reference,
                          productRef: widget.productoDoc?.reference,
                          description:
                              _model.addicionalDescriptionTextController.text,
                          subtotal: widget.productoDoc?.price,
                          total: FFAppState().totalBeforeAddingToCart,
                          amount: _model.countControllerValue,
                        ),
                        ...mapToFirestore(
                          {
                            'extra_ingredients': FFAppState().extraIngredients,
                          },
                        ),
                      });
