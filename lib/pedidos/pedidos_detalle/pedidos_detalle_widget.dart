...
class PedidosDetalleWidget extends StatefulWidget {
  const PedidosDetalleWidget({
    super.key,
    required this.orderDocumentID,
  });

  /// Id of the order
  final CustomerOrdersRecord? orderDocumentID;
...
class _PedidosDetalleWidgetState extends State<PedidosDetalleWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CustomerOrdersRecord>(
      stream:
          CustomerOrdersRecord.getDocument(widget.orderDocumentID!.reference),
      builder: (context, snapshot) {
        ...
        final pedidosDetalleCustomerOrdersRecord = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            StreamBuilder<StatesRecord>(
                              stream: StatesRecord.getDocument(
                                  pedidosDetalleCustomerOrdersRecord.stateRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                            ...
                            Text(
                              '${dateTimeFormat("yMMMd", pedidosDetalleCustomerOrdersRecord.orderDate)} ${dateTimeFormat("jm", pedidosDetalleCustomerOrdersRecord.orderDate)}',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Inter',
                          ...
                          children: [
                            StreamBuilder<List<StatesRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<StatesRecord>
                                    nombreEstadosStatesRecordList =
                                    snapshot.data!;

                                return FlutterFlowDropDown<String>(
                                  controller:
                                      _model.nombreEstadosValueController ??=
                                          FormFieldController<String>(null),
                                  options: nombreEstadosStatesRecordList
                                      .map((e) => e.name)
                                      .toList(),
                                  onChanged: (val) => safeSetState(
                                      () => _model.nombreEstadosValue = val),
                                  width: 200.0,
                                  height: 40.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                await actions.updateCustomerOrderStateCA(
                                  widget.orderDocumentID?.reference,
                                  _model.nombreEstadosValue,
                                );
                              },
                              text: 'Editar Estado',
                              options: FFButtonOptions(
                                ...
                                iconPadding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 0.0),
                                color: FlutterFlowTheme.of(context).smokers3,
                                textStyle: FlutterFlowTheme.of(context)
                                    .titleSmall
                                    .override(
                                      fontFamily: 'Inter Tight',
                  ...
                  StreamBuilder<List<CustomerOrderDetailsRecord>>(
                    stream: queryCustomerOrderDetailsRecord(
                      queryBuilder: (customerOrderDetailsRecord) =>
                          customerOrderDetailsRecord.where(
                        'customer_orderRef',
                        isEqualTo: widget.orderDocumentID?.reference,
                      ),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      ...
                      List<CustomerOrderDetailsRecord>
                          listViewCustomerOrderDetailsRecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount:
                            listViewCustomerOrderDetailsRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewCustomerOrderDetailsRecord =
                              listViewCustomerOrderDetailsRecordList[
                                  listViewIndex];
                          return Padding(
                            padding: EdgeInsets.all(10.0),
                            child: StreamBuilder<ProductsRecord>(
                              stream: ProductsRecord.getDocument(
                                  listViewCustomerOrderDetailsRecord
                                      .productRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                ...
                                return Material(
                                  ...
                                  child: ListTile(
                                    title: Text(
                                      '${listTileProductsRecord.name}   x ${listViewCustomerOrderDetailsRecord.amount.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .titleLarge
                                          .override(
                                            fontFamily: 'Inter Tight',
                                    ...
                                    subtitle: Text(
                                      '₡${listViewCustomerOrderDetailsRecord.total.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Inter',
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<PaymentMethodsRecord>(
                            stream: PaymentMethodsRecord.getDocument(
                                widget.orderDocumentID!.paymentMethodRef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '₡${widget.orderDocumentID?.subtotal.toString()}',
                                                textAlign: TextAlign.end,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelSmall
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '₡${widget.orderDocumentID?.tax.toString()}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelSmall
                                                        .override(
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '₡${widget.orderDocumentID?.total.toString()}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .displaySmall
                                                        .override(
